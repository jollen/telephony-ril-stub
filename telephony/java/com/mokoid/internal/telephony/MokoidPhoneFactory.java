...
import com.android.internal.telephony.wimax.WIMAXPhone;
 ...
 * {@hide}
 */
public class MokoidPhoneFactory {
    ...
    public static void makeDefaultPhone(Context context) {
        synchronized(Phone.class) {
            if (!sMadeDefaults) {
                ...
                sProxyPhone = new PhoneProxy(new WIMAXPhone(context, 
                            sCommandsInterface, sPhoneNotifier));
                Log.i(LOG_TAG, "Creating WiMAXPhone");
